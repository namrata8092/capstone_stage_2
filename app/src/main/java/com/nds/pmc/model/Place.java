...
public class Place implements Parcelable{
    ...
    public boolean isWidgetEntry() {
        return widgetEntry;
    }

    public void setWidgetEntry(boolean widgetEntry) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte((byte) (widgetEntry ? 1 : 0));
    }
}
